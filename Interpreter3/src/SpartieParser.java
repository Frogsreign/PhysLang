...
public class SpartieParser {
    ...
    private Statement forStatement() {
        ...
        List<Statement> whileBlock = new ArrayList<>();
        whileBlock.add(body);
        whileBlock.add(new Statement.ExpressionStatement(increment));

        block.add(new Statement.WhileStatement(condition, new Statement.BlockStatement(whileBlock)));
        return new Statement.BlockStatement(block);
    }
